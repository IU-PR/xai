...
First, unlike gradient-based methods such as Grad-CAM, ScoreCAM does not rely on
...
On the other hand, images that contain open skies and water — which are common
